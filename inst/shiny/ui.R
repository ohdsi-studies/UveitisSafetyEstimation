...
shinyUI(
  fluidPage(
    style = "width:1500px;",
    titlePanel(
      title = paste("Remicade/Uveitis safety study", if(blind) "***Blinded***" else "")
    ),
    tags$head(
      tags$style(
        type = "text/css",
    ...
    tabsetPanel(
      ...
      tabPanel(
        title = "About",
        HTML("<br/>"),
        div(p("These research results are from a retrospective, real-world, observational study assessing the risk of uveitis among patients newly exposed to Remicade and compartor therapies for.... This web-based application provides an interactive platform to explore all analysis results generated as part of this study, as a supplement to the full manuscript published in the journal ...."), style="border: 1px solid black; padding: 5px;"),
        HTML("<br/>"),
        ...
        # HTML("<li>Threats to causal inference validity when using observational data...</li>"),
        # HTML("<li>Set of validity diagnsotics to assess causal evidence reliability...</li>"),
        # HTML("<li>In answering complex research question, diagnostics kept us from making overconfident casual conclusions.</li>"),
        # HTML("<br/>"),
        ...
        HTML("<li>The study was registered Encepp: <a href=\"https://www.encepp.eu/encepp/studiesDatabase.jsp\">https://www.encepp.eu/encepp/studiesDatabase.jsp</a></li>"),
        HTML("<li>The full study protocol is available at: <a href=\"https://data,ohdsi.org\">https://www.encepp.eu/encepp/studiesDatabase.jsp</a></li>"),
